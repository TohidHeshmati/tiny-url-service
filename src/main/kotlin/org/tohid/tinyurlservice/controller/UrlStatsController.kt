...
class UrlStatsController(
    ...
    @Operation(summary = "Get system-wide summary statistics")
    @ApiResponse(responseCode = "200", description = "Summary retrieved successfully")
    fun getSystemSummary(): ResponseEntity<SystemSummaryResponse> = ResponseEntity.ok(urlService.getSystemSummary())
}
